...
export const INITIAL_CABINET_MEMBERS: CabinetMember[] = [
  ...
  {
    id: 'cab-gs-sindh',
    fullName: 'RAO HUMAYUN FARRUKH',
    designation: 'General Secretary, NYP Sindh',
    cabinetLevel: 'PROVINCIAL',
    photoUrl: '/nyp-general-secretary.png',
    bio: 'General Secretary overseeing organizational governance, youth capacity building, and parliamentary affairs across Sindh.',
    displayOrder: 2,
    isActive: true,
    category: 'CABINET'
  },
